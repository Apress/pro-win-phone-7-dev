...
namespace AlienShooter.ParticleSystem
{
    /// <summary>
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        private AlienShooter.AlienShooterGame game;
        ...
        protected ParticleSystem(AlienShooter.AlienShooterGame game, int howManyEffects)
            : base(game)
        {            
            this.game = game;
        ...
        /// <summary>
        /// overriden from DrawableGameComponent, Draw will use AlienShooter.AlienShooterGame's 
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // initializeConstants
          ((ScreenManager)game.Components[0]).SpriteBatch.Begin(SpriteSortMode.Deferred, blendState);
            ...
            foreach (Particle p in particles)
            {
                ...
                ((ScreenManager)game.Components[0]).SpriteBatch.Draw(texture, p.Position, null, color,
                    p.Rotation, origin, scale, SpriteEffects.None, 0.0f);
            }

            ((ScreenManager)game.Components[0]).SpriteBatch.End();

            base.Draw(gameTime);
        }

        #region Particle System Helper Members
